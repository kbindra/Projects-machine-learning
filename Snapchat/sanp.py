...
moustache = cv2.imread('Haar_for_eyes/mustache.png',-1)
glasses = cv2.imread('Haar_for_eyes/glasses.png',-1)
face_cascade = cv2.CascadeClassifier('haarcascade_frontalface_alt.xml')
eyes_cascade = cv2.CascadeClassifier('Haar_for_eyes/frontalEyes35x16.xml')
nose_cascade = cv2.CascadeClassifier('Haar_for_eyes/Nose18x15.xml')
